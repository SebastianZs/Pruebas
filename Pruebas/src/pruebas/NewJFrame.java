   ...
   public String  palabraADescubrir;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jPasswordField1.getText().equals("")){
            JOptionPane.showMessageDialog(NewJFrame.this,"Por favor ingrese una palabra");
        }else{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jPasswordField1.getText().equals("")){
            ...
            if (contadorBoton1==0){
            JOptionPane.showMessageDialog(NewJFrame.this,"Por favor orpima el boton ingresar");
            }else{
        if(jTextField1.getText().equals("")){
            JOptionPane.showMessageDialog(NewJFrame.this,"Por favor ingrese una letra");
        } else{  
        ...
        if(contieneLetra==true){
            ...
            vidasRestantes--;
            jTextField2.setText(new Integer(vidasRestantes).toString());
            System.out.println("Vidas restantes: "+vidasRestantes);
        }
        }
        }
